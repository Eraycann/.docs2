...
function Auth() {
    ...
    const sendRequest = (path) => {
        PostWithoutAuth(("/auth/"+path), {
          ...
          .then((res) => res.json())
          // backend den gelen bzaı bazı bilgileri front end tarafından localStorage'ye kaydetmek istiyprum.
    ...
    const handleButton = (path) => {
        ...
        //history.go("/auth")   // register olduktan sonra /auth sayfasına gitmesini sağlar
        // geliştirici ekranı > network, login olduktan sonra bize message : token dönecektir, response olarak.
    }
